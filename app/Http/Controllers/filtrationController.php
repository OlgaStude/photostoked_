    ...
    public function filter(Request $req)
    {
        ...
        if ($req->type != '' && $req->format != '') {
            ...
            if ($req->search_word != '') {
                ...
                $materials = approved_material::where('type', '=', $req->type)->orderBy('id', 'desc')->paginate(2);
            }
        } elseif ($req->format != '') {
            if ($req->search_word != '') {
                $materials = tag_material::join('tags', 'tags.id', '=', 'tag_materials.tags_id')
                ...
                $materials = approved_material::where('format', '=', $req->format)->orderBy('id', 'desc')->paginate(2);
            }
        }
