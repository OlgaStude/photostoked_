...
class materialsController extends Controller
{
    ...
    public function show_in_main()
    {
        ...
        $materials = approved_material::orderBy('id', 'desc')->paginate(1);
    ...
    public function show_users($id)
    {
        ...
        $materials = approved_material::where('users_id', '=', $id)->orderBy('id', 'desc')->paginate(2);
    ...
    public function show_liked($id)
    {
        ...
        ->orderBy('approved_materials.id', 'desc')->paginate(2);
    ...
    public function approve(approvalRequest $req)
    {
        ...
        foreach ($tags as $tag) {
            ...
            $check = tag_material::create(['approved_materials_id' => $new_material->id, 'tags_id' => $tag_id[0]->id]);
        }
